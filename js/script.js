...
$(document).ready(function() {
    ...
    $('form .btn-next').on('click', function() {
		...
		var choose = $("input[name='opttypetable']:checked").val();
		...
		if( next_step ) 
		{
				...
				parent_fieldset.fadeOut(400, function() {
					...
					// else if (choose == "2")
					// {
					// 	current_active_step.removeClass('active').addClass('activated').next().removeClass('active').addClass('activated').next().addClass('active');
					// 	bar_progress(progress_line, 'right');
